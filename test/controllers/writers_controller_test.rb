...
class WritersControllerTest < ActionController::TestCase
  ...
  test "should create writer" do
    assert_difference('Writer.count') do
      post :create, writer: { first_name: @writer.first_name, last_name: @writer.last_name, summary: @writer.summary }
    end
  ...
  test "should update writer" do
    patch :update, id: @writer, writer: { first_name: @writer.first_name, last_name: @writer.last_name, summary: @writer.summary }
    assert_redirected_to writer_path(assigns(:writer))
  end
